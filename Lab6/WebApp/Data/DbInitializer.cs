...
namespace WebApp.Data
{
    public static class DbInitializer
    {
        public static void Initialize(RecPointContext db)
        {
            ...
            const int positionsNumber = 10;
            const int storageTypesNumber = 10;
            const int recyclableTypesNumber = 10;
            const int employeesNumber = 100;
            const int storagesNumber = 100;
            const int acceptedRecyclableNumber = 100;
